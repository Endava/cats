...
@QuarkusTest
class GetHasBodyLinterFuzzerTest {
    private TestCaseListener testCaseListener;
    private GetHasBodyLinterFuzzer getHasBodyLinterFuzzer;
    ...
    void setup() {
        ...
        getHasBodyLinterFuzzer = new GetHasBodyLinterFuzzer(testCaseListener);
    }
