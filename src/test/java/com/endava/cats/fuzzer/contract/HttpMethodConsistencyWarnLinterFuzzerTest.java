...
@QuarkusTest
class HttpMethodConsistencyWarnLinterFuzzerTest {
    private TestCaseListener testCaseListener;
    private HttpMethodConsistencyWarnLinterFuzzer httpMethodConsistencyWarnLinterFuzzer;
    @Inject
    ...
    void setup() {
        ...
        httpMethodConsistencyWarnLinterFuzzer = new HttpMethodConsistencyWarnLinterFuzzer(testCaseListener, httpMethodConsistencyAnalyzer);
    }
