...
@QuarkusTest
class HttpMethodConsistencyErrorLinterFuzzerTest {
    private TestCaseListener testCaseListener;
    private HttpMethodConsistencyErrorLinterFuzzer httpMethodConsistencyErrorLinterFuzzer;
    @Inject
    ...
    void setup() {
        ...
        httpMethodConsistencyErrorLinterFuzzer = new HttpMethodConsistencyErrorLinterFuzzer(testCaseListener, httpMethodConsistencyAnalyzer);
    }
