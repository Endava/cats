...
@QuarkusTest
class TopLevelElementsLinterTest {

    private TestCaseListener testCaseListener;

    private TopLevelElementsLinter topLevelElementsContractInfoFuzzer;
    ...
    void setup() {
        ...
        topLevelElementsContractInfoFuzzer = new TopLevelElementsLinter(testCaseListener);
    }
