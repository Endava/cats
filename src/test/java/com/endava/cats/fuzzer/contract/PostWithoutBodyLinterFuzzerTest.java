...
@QuarkusTest
class PostWithoutBodyLinterFuzzerTest {
    private TestCaseListener testCaseListener;
    private PostWithoutBodyLinterFuzzer postWithoutBodyLinterFuzzer;
    ...
    void setup() {
        ...
        postWithoutBodyLinterFuzzer = new PostWithoutBodyLinterFuzzer(testCaseListener);
    }
