...
@QuarkusTest
class SecuritySchemesLinterTest {
    private TestCaseListener testCaseListener;

    private SecuritySchemesLinter securitySchemesContractInfoFuzzer;
    ...
    void setup() {
        ...
        securitySchemesContractInfoFuzzer = new SecuritySchemesLinter(testCaseListener);
    }
