...
@QuarkusTest
class UniqueOperationIdsLinterFuzzerTest {
    private TestCaseListener testCaseListener;
    private UniqueOperationIdsLinterFuzzer uniqueOperationIdsLinterFuzzer;
    ...
    void setup() {
        ...
        uniqueOperationIdsLinterFuzzer = new UniqueOperationIdsLinterFuzzer(testCaseListener);
    }
