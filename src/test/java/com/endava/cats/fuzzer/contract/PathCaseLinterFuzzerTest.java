...
@QuarkusTest
class PathCaseLinterFuzzerTest {

    private TestCaseListener testCaseListener;
    private PathCaseLinterFuzzer pathCaseLinterFuzzer;
    @Inject
    ...
    void setup() {
        ...
        pathCaseLinterFuzzer = new PathCaseLinterFuzzer(testCaseListener, namingArguments);
