...
class ZalgoTextInHeadersFuzzerTest {
    ...
    void shouldHaveAllMethodsOverridden() {
        ...
        Assertions.assertThat(zalgoTextInHeadersFuzzer.getFuzzerContext().getFuzzStrategy().get(0).name()).isEqualTo(FuzzingStrategy.replace().name());
