...
class LeadingSingleCodePointEmojisInFieldsTrimValidateFuzzerTest {
    ...
    void setup() {
        ...
        leadingSingleCodePointEmojisInFieldsTrimValidateFuzzer = new LeadingSingleCodePointEmojisInFieldsTrimValidateFuzzer(serviceCaller, testCaseListener, filesArguments);
    ...
    void givenANewLeadingTabsInFieldsTrimValidateFuzzer_whenCreatingANewInstance_thenTheMethodsBeingOverriddenAreMatchingTheLeadingTabsInFieldsTrimValidateFuzzer() {
        ...
        Assertions.assertThat(leadingSingleCodePointEmojisInFieldsTrimValidateFuzzer.getExpectedHttpCodeWhenFuzzedValueNotMatchesPattern()).isEqualTo(ResponseCodeFamilyPredefined.TWOXX);
    ...
    void shouldNotFuzzIfDiscriminatorField() {
        Assertions.assertThat(leadingSingleCodePointEmojisInFieldsTrimValidateFuzzer.isFuzzerWillingToFuzz(null, "pet#type")).isFalse();
    }

    @Test
    void shouldFuzzIfNotDiscriminatorField() {
        Assertions.assertThat(leadingSingleCodePointEmojisInFieldsTrimValidateFuzzer.isFuzzerWillingToFuzz(null, "pet#number")).isTrue();
    }
}
