...
class LeadingControlCharsInFieldsTrimValidateFuzzerTest {
    ...
    void setup() {
        ...
        leadingControlCharsInFieldsTrimValidateFuzzer = new LeadingControlCharsInFieldsTrimValidateFuzzer(serviceCaller, testCaseListener, filesArguments);
    ...
    void givenANewLeadingTabsInFieldsTrimValidateFuzzer_whenCreatingANewInstance_thenTheMethodsBeingOverriddenAreMatchingTheLeadingTabsInFieldsTrimValidateFuzzer() {
        ...
        Assertions.assertThat(leadingControlCharsInFieldsTrimValidateFuzzer.getExpectedHttpCodeWhenFuzzedValueNotMatchesPattern()).isEqualTo(ResponseCodeFamilyPredefined.TWOXX);
