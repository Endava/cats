...
@QuarkusTest
class LowercaseExpandingBytesInStringFieldsFuzzerTest {
    ServiceCaller serviceCaller;
    @InjectSpy
    TestCaseListener testCaseListener;
    FieldsIteratorExecutor catsExecutor;
    LowercaseExpandingBytesInStringFieldsFuzzer lowercaseExpandingBytesInStringFieldsFuzzer;
    ...
    void setup() {
        ...
        lowercaseExpandingBytesInStringFieldsFuzzer = new LowercaseExpandingBytesInStringFieldsFuzzer(testCaseListener, catsExecutor);
    }

    @Test
    void shouldHaveDescription() {
        Assertions.assertThat(lowercaseExpandingBytesInStringFieldsFuzzer.description()).isNotBlank();
    }

    @Test
    void shouldHaveToString() {
        Assertions.assertThat(lowercaseExpandingBytesInStringFieldsFuzzer).hasToString("LowercaseExpandingBytesInStringFieldsFuzzer");
    }

    @Test
    void shouldSkipForNonBodyMethods() {
        Assertions.assertThat(lowercaseExpandingBytesInStringFieldsFuzzer.skipForHttpMethods()).isEmpty();
    }
    ...
    void shouldSkipIfNotStringSchema() {
        ...
        Mockito.when(data.getPayload()).thenReturn("""
                    {"myField": 3}
                """);
        lowercaseExpandingBytesInStringFieldsFuzzer.fuzz(data);
