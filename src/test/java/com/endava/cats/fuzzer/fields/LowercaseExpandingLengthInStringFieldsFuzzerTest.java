...
@QuarkusTest
class LowercaseExpandingLengthInStringFieldsFuzzerTest {
    ServiceCaller serviceCaller;
    @InjectSpy
    TestCaseListener testCaseListener;
    FieldsIteratorExecutor catsExecutor;
    LowercaseExpandingLengthInStringFieldsFuzzer lowercaseExpandingLengthInStringFieldsFuzzer;
    ...
    void setup() {
        ...
        lowercaseExpandingLengthInStringFieldsFuzzer = new LowercaseExpandingLengthInStringFieldsFuzzer(testCaseListener, catsExecutor);
    }

    @Test
    void shouldHaveDescription() {
        Assertions.assertThat(lowercaseExpandingLengthInStringFieldsFuzzer.description()).isNotBlank();
    }

    @Test
    void shouldHaveToString() {
        Assertions.assertThat(lowercaseExpandingLengthInStringFieldsFuzzer).hasToString("LowercaseExpandingLengthInStringFieldsFuzzer");
    }

    @Test
    void shouldSkipForNonBodyMethods() {
        Assertions.assertThat(lowercaseExpandingLengthInStringFieldsFuzzer.skipForHttpMethods()).isEmpty();
    }
    ...
    void shouldSkipIfNotStringSchema() {
        ...
        Mockito.when(data.getPayload()).thenReturn("""
                    {"myField": 3}
                """);
        lowercaseExpandingLengthInStringFieldsFuzzer.fuzz(data);
