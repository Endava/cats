...
class WithinSingleCodePointEmojisInStringFieldsValidateTrimFuzzerTest {
    ...
    void setup() {
        ...
        withinSingleCodePointEmojisInStringFieldsValidateTrimFuzzer = new WithinSingleCodePointEmojisInStringFieldsValidateTrimFuzzer(serviceCaller, testCaseListener, catsUtil, filesArguments);
    ...
    void shouldNotFuzzIfDiscriminatorField() {
        Assertions.assertThat(withinSingleCodePointEmojisInStringFieldsValidateTrimFuzzer.isFuzzingPossibleSpecificToFuzzer(null, "pet#type", null)).isFalse();
    }

    @Test
    void shouldFuzzIfNotDiscriminatorField() {
        Assertions.assertThat(withinSingleCodePointEmojisInStringFieldsValidateTrimFuzzer.isFuzzingPossibleSpecificToFuzzer(null, "pet#number", null)).isTrue();
    }
}
