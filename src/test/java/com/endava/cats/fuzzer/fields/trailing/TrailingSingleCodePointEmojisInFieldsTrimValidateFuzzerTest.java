...
class TrailingSingleCodePointEmojisInFieldsTrimValidateFuzzerTest {
    ...
    void setup() {
        ...
        trailingSingleCodePointEmojisInFieldsTrimValidateFuzzer = new TrailingSingleCodePointEmojisInFieldsTrimValidateFuzzer(serviceCaller, testCaseListener, filesArguments);
    ...
    void shouldNotFuzzIfDiscriminatorField() {
        Assertions.assertThat(trailingSingleCodePointEmojisInFieldsTrimValidateFuzzer.isFuzzerWillingToFuzz(null, "pet#type")).isFalse();
    }

    @Test
    void shouldFuzzIfNotDiscriminatorField() {
        Assertions.assertThat(trailingSingleCodePointEmojisInFieldsTrimValidateFuzzer.isFuzzerWillingToFuzz(null, "pet#number")).isTrue();
    }
}
