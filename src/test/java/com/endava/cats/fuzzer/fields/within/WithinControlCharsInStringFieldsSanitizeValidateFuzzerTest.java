...
class WithinControlCharsInStringFieldsSanitizeValidateFuzzerTest {
    ...
    void shouldNotFuzzIfDiscriminatorField() {
        Assertions.assertThat(withinControlCharsInStringFieldsSanitizeValidateFuzzer.isFuzzingPossibleSpecificToFuzzer(null, "pet#type", null)).isFalse();
    }

    @Test
    void shouldFuzzIfNotDiscriminatorField() {
        Assertions.assertThat(withinControlCharsInStringFieldsSanitizeValidateFuzzer.isFuzzingPossibleSpecificToFuzzer(null, "pet#number", null)).isTrue();
    }
}
