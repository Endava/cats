...
class IPV4GeneratorTest {
    ...
    @ParameterizedTest
    @CsvSource({"not,ip,true", "not,ipaddress,true", "not,hostIp,true", "not,zip,false", "ip,something,true", "ipv4,something,true", "not,something,false","not,citizenship,false"})
