...
class StringGeneratorTest {
    ...
    @CsvSource(value = {
            ...
            "^urn:tdm:(([a-z]{2}-(gov-)?[a-z]{4,9}-[0-9]{1,3}/[0-9]+/)*[\\p{Alnum}_]+(/[\\p{Alnum}_]+)*):([\\p{Alpha}]*):([\\p{Alnum}_]+(/[\\p{Alnum}_]+)*)$; -1; -1; 1; 300",
            "^$|/.*; 1; 1024; 1; 1024",
            "^$|/.*; -1; -1; 1; 1024",
