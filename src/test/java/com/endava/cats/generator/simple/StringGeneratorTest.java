...
class StringGeneratorTest {
    ...
    void shouldGenerateComplexEmailRegex() {
        ...
        String longEmail = "a." + "a".repeat(5986) + "@example.com";
        Assertions.assertThat(StringGenerator.matchesPattern(longEmail, regex)).isTrue();

        try {
            String generated = StringGenerator.generate(regex, 1, 6000);
            Assertions.assertThat(generated).hasSizeBetween(1, 6000);
            Assertions.assertThat(StringGenerator.matchesPattern(generated, regex)).isTrue();
