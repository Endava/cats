...
public class CatsUtil {
    ...
    public static final List<String> WHITESPACES_HEADERS = Arrays.asList(
            ...
            "\u205F",
            "\u3000");
    public static final List<String> WHITESPACES_FIELDS = Arrays.asList(
            " ",
            "\u1680",
            "\u2000",
            "\u2001",
    ...
    public static final List<String> CONTROL_CHARS_HEADERS = Arrays.asList(
            "\r\n",
            "\u0000",
            "\u0007",
            "\u0008",
    ...
    public static final List<String> CONTROL_CHARS_FIELDS = Arrays.asList(
            "\r\n",
            "\u0000",
            "\u0007",
            "\u0008",
