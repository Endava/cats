...
@RegisterForReflection(targets = {
        ...
        FuzzerListEntry.class, FuzzerListEntry.FuzzerDetails.class, TimeExecutionDetails.class, TimeExecution.class, CatsTestReport.class, CatsResultFactory.class, CatsResultFactory.CatsResult.class, CatsTestCase.class, KeyValuePair.class, CatsResponse.class, CatsRequest.class, ResourceCorrelation.class, RequestProvenance.class, RequestTarget.class, RequestTarget.Location.class, ExecutionSummary.class, RunOutcome.class, RunOutcome.Status.class, ProcessingError.class, PathListEntry.class, PathListEntry.PathDetails.class, InfoCommand.CatsInfo.class, StatsCommand.Stats.class, PathDetailsEntry.class, PathDetailsEntry.OperationDetails.class, ValidContractEntry.class, JsonSchema.class, MutatorEntry.class,
