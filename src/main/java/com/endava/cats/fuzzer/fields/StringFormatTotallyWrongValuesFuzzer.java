...
public class StringFormatTotallyWrongValuesFuzzer extends BaseBoundaryFieldFuzzer {
    ...
    /**
     * Creates a new StringFormatTotallyWrongValuesFuzzer instance.
     *
     ...
     */
    public StringFormatTotallyWrongValuesFuzzer(ServiceCaller sc, TestCaseListener lr, FilesArguments cp, InvalidDataFormat invalidDataFormat) {
        super(sc, lr, cp);
