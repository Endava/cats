...
@Singleton
@FieldFuzzer
public class NumericBooleansInBooleanFieldsFuzzer extends BaseTypeCoercionFuzzer {
    /**
     * Creates a new NumericBooleansInBooleanFieldsFuzzer instance.
     *
     * @param simpleExecutor      the executor used to run the fuzz logic
     * @param processingArguments the processing arguments
     */
    public NumericBooleansInBooleanFieldsFuzzer(SimpleExecutor simpleExecutor, ProcessingArguments processingArguments) {
