...
public class LeadingSingleCodePointEmojisInFieldsTrimValidateFuzzer extends InvisibleCharsBaseTrimValidateFuzzer {
    ...
    /**
     * Creates a new LeadingSingleCodePointEmojisInFieldsTrimValidateFuzzer instance.
     *
     ...
     */
    protected LeadingSingleCodePointEmojisInFieldsTrimValidateFuzzer(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
