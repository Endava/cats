...
@Singleton
@FieldFuzzer
public class BooleanValuesInStringFieldsFuzzer extends BaseTypeCoercionFuzzer {
    /**
     * Creates a new BooleanValuesInStringFieldsFuzzer instance.
     *
     * @param simpleExecutor      the executor used to run the fuzz logic
     * @param processingArguments the processing arguments
     */
    public BooleanValuesInStringFieldsFuzzer(SimpleExecutor simpleExecutor, ProcessingArguments processingArguments) {
