...
/**
 * The fuzzer that sends values that will expand their length when lower cased.
 */
@Singleton
@FieldFuzzer
public class LowercaseExpandingLengthInStringFieldsFuzzer extends TwoXXorFourXXReplaceStringsFuzzer {
    /**
     ...
     */
    public LowercaseExpandingLengthInStringFieldsFuzzer(TestCaseListener testCaseListener, FieldsIteratorExecutor fieldsIteratorExecutor) {
    ...
    protected BiFunction<Schema<?>, String, List<Object>> fuzzValueProducer() {
        return (schema, s) -> {
            ...
            return List.of(CatsUtil.selectRandom(UnicodeGenerator.getLowercaseExpandingLength(), schemaLength));
        };
    }
