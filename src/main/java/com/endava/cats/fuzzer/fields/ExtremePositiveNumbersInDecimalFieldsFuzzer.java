...
/**
 * Fuzzer that will send an extreme positive number in decimal fields.
 */
@Singleton
@FieldFuzzer
public class ExtremePositiveNumbersInDecimalFieldsFuzzer extends BaseBoundaryFieldFuzzer {
    ...
    /**
     * Creates a new ExtremePositiveNumbersInDecimalFieldsFuzzer instance.
     *
     * @param sc the service caller
     * @param lr the test case listener
     * @param cp files arguments
     */
    public ExtremePositiveNumbersInDecimalFieldsFuzzer(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
