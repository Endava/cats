...
@Linter
@Singleton
public class HttpMethodConsistencyErrorLinter extends BaseLinter {
    private static final PrettyLogger LOG = PrettyLoggerFactory.getLogger(HttpMethodConsistencyErrorLinter.class);

    private final HttpMethodConsistencyAnalyzer analyzer;

    @Inject
    public HttpMethodConsistencyErrorLinter(TestCaseListener testCaseListener, HttpMethodConsistencyAnalyzer analyzer) {
