...
@Linter
@Singleton
public class UniqueOperationIdsLinter extends BaseLinter {
    private final PrettyLogger log = PrettyLoggerFactory.getLogger(this.getClass());

    /**
     * Creates a new UniqueOperationIdsLinter instance.
     *
     * @param tcl the test case listener
     */
    public UniqueOperationIdsLinter(TestCaseListener tcl) {
        super(tcl);
    }
