...
@LinterFuzzer
@Singleton
public class OperationIdVerbPrefixLinterFuzzer extends BaseLinterFuzzer {
    private final PrettyLogger log = PrettyLoggerFactory.getLogger(this.getClass());
    private final NamingArguments namingArguments;

    public OperationIdVerbPrefixLinterFuzzer(TestCaseListener tcl, NamingArguments namingArguments) {
        super(tcl);
