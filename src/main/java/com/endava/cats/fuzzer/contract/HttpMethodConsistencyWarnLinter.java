...
@Linter
@Singleton
public class HttpMethodConsistencyWarnLinter extends BaseLinter {
    private static final PrettyLogger LOG = PrettyLoggerFactory.getLogger(HttpMethodConsistencyWarnLinter.class);

    private final HttpMethodConsistencyAnalyzer analyzer;

    @Inject
    public HttpMethodConsistencyWarnLinter(TestCaseListener testCaseListener, HttpMethodConsistencyAnalyzer analyzer) {
