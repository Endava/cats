...
@Linter
@Singleton
public class QueryParamsCaseLinter extends BaseLinter {
    private final PrettyLogger log = PrettyLoggerFactory.getLogger(this.getClass());
    private final NamingArguments namingArguments;

    /**
     * Creates a new QueryParamsCaseLinter instance.
     *
     * @param tcl      the test case listener
     * @param nameArgs naming arguments used to get expected naming case
     */
    public QueryParamsCaseLinter(TestCaseListener tcl, NamingArguments nameArgs) {
        super(tcl);
